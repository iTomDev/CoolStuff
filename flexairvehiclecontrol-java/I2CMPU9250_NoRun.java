...
public class I2CMPU9250_NoRun 
{
    ...
    public void init(SafeI2C i2cin)
    {
        ...
        //{
            ...
            // Try 0x02 to see if it does anything
            ...
            i2c.write(device,(byte)0x1B, (byte)0x0E); // was 0x0C
            ...
            // Note that the a 5Hz filter introduces a 67ms delay
            i2c.write(device,(byte)0x1D, (byte)0x08); // was 0x0E
